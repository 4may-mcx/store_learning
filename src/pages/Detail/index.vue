        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(attr, index1) in spuSaleAttrList" :key="attr.id">
                <dt class="title">{{ attr.saleAttrName }}</dt>
                <dd
                  changepirce="0"
                  :class="{ active: item.isChecked == 1 }"
                  v-for="(item, index2) in attr.spuSaleAttrValueList"
                  :key="item.id"
                  @click="changeChecked(index1, index2)"
                >
...
export default {
  ...
  methods: {
    changeChecked(index1, index2) {
      let curObj = this.spuSaleAttrList[index1].spuSaleAttrValueList[index2];
      if (curObj.isChecked != 1) {
